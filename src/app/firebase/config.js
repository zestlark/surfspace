...
import { getDatabase, ref as dbref, set as dbset, get as dbget, onValue as dbOnValue, remove as dbremove } from "firebase/database";
...
export { database, dbref, dbset, dbget, dbOnValue, dbremove, analytics, auth };