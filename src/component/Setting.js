...
const Setting = () => {
    ...
    return (
        <div onClick={(e) => e.stopPropagation()} className='w-[100%] md:w-[350px] bg-white dark:bg-slate-800 min-h-[350px] max-h-[50%] md:max-h-[500px] overflow-scroll p-3 rounded-2xl pb-5 no-scrollbar slide-top'>
            <p>Setting</p>
            <div>
